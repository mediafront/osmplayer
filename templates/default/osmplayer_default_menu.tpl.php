<div id="<?php print $params['prefix']; ?>mediamenu" class="<?php print $params['prefix']; ?>ui-tabs <?php print $params['prefix']; ?>ui-widget <?php print $params['prefix']; ?>ui-widget-content <?php print $params['prefix']; ?>ui-corner-all" id="tabs">
   ...
   <div id="<?php print $params['prefix']; ?>mediaembed" class="<?php print $params['prefix']; ?>ui-tabs-panel <?php print $params['prefix']; ?>ui-widget-content <?php print $params['prefix']; ?>ui-corner-bottom" id="<?php print $params['prefix']; ?>mediaembed">
   ...
   <div id="<?php print $params['prefix']; ?>mediaelink" class="<?php print $params['prefix']; ?>ui-tabs-panel <?php print $params['prefix']; ?>ui-widget-content <?php print $params['prefix']; ?>ui-corner-bottom" id="<?php print $params['prefix']; ?>mediaelink">
   ...
   <div id="<?php print $params['prefix']; ?>mediainfo" class="<?php print $params['prefix']; ?>ui-tabs-panel <?php print $params['prefix']; ?>ui-widget-content <?php print $params['prefix']; ?>ui-corner-bottom" id="<?php print $params['prefix']; ?>mediainfo">
      <p>
